 ...
 */
public class EvaluationResult extends BasicResult
		implements TextWriteable, Iterable<EvaluationResult.MeasurementGroup> {
	/**
	 * Measurements.
	 */
	...
	public void writeToText(TextWriterStream out, String label) {
		...
		try {
			writeTxtFile(resultContent, "C:\\Users\\Administrator\\Desktop\\博士后研究工作\\正在进行的工作\\试验原始数据\\output.txt");
		} catch (Exception e) {
	 ...
	 */
	public static EvaluationResult findOrCreate(ResultHierarchy hierarchy, Result parent, String name,
			String shortname) {
	...
	public static class MeasurementGroup implements Iterable<Measurement> {
		 ...
		 * @return {@code this} (Builder pattern)
		 */
		public MeasurementGroup addMeasure(String name, double val, double min, double max, double exp,
