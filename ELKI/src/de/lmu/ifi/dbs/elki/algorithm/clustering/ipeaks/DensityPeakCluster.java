...
public class DensityPeakCluster<O> extends AbstractDistanceBasedAlgorithm<O, Clustering<Model>>
		implements ClusteringAlgorithm<Clustering<Model>> {
	private static final Logging LOG = Logging.getLogger(DensityPeakClusterMerge.class);

	protected DensityPeakCluster(DistanceFunction<? super O> distanceFunction, double deltaThreshold,
	...
	public static class Parameterizer<O> extends AbstractDistanceBasedAlgorithm.Parameterizer<O> {
		...
		@Override
		protected DensityPeakCluster<O> makeInstance() {
			return new DensityPeakCluster<>(distanceFunction, deltaThreshold, rhoThreshold, multiValue);
		}
	}
}
